...
<style>
    ...
    /* Testimoni slider button styling */
    .swiper-testimonials .swiper-button-prev,
    .swiper-testimonials .swiper-button-next {
        width: 40px;
        height: 40px;
        top: auto;
        /* Bebas dari tengah gambar */
        bottom: 15%;
        /* Posisikan di tengah kolom */
        border: none;
    }

    .swiper-testimonials .swiper-button-prev {
        left: 45%;
        /* Tengah kolom, sisi kiri */
        transform: translate(-150%, 0);
    }

    .swiper-testimonials .swiper-button-next {
        right: 45%;
        /* Tengah kolom, sisi kanan */
        transform: translate(150%, 0);
    }
    ...
    .swiper-testimonials .swiper-button-next:after {
        font-size: 12px;
        /* Ukuran panah lebih kecil khusus slider testimoni */
    }
</style>
